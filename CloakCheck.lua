...
dragger:SetScript("OnMouseDown", function() CloakCheck.top_level_frame:StartMoving() end)
dragger:SetScript("OnMouseUp", function() CloakCheck.top_level_frame:StopMovingOrSizing() end)
